...
import { filterDirectUserChannelISAs, filterEmployerChannelISAs } from './filter.ts';

export function parseAPIData(user: User | undefined, data: ISAItem[] | undefined): ISAItem[] {
    if (!user) {
